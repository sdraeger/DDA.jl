...
function _run_matrix_with_temp(
    ...
    try
        return file_runner(tmp, collect(1:n_ch); kwargs...)
    finally
...
function _run_st_matrix(
    ...
    return _run_matrix_with_temp(data, _run_st_file;
        sfreq=sfreq,
        delays=delays,
        model=model,
        WL=WL,
...
function _run_ct_matrix(
    ...
    return _run_matrix_with_temp(data, _run_ct_file;
        sfreq=sfreq,
        delays=delays,
        model=model,
        WL=WL,
...
function _run_de_matrix(
    ...
    return _run_matrix_with_temp(data, _run_de_file;
        sfreq=sfreq,
        delays=delays,
        model=model,
        WL=WL,
